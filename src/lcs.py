def longest_common_subsequence_length(str1: str, str2: str) -> int:
    ...
    # If the case-insensitive strings are the same but not exactly the same
    ...
    # Compute LCS lengths with strict character matching
    for i in range(1, m + 1):
        for j in range(1, n + 1):
            # Explicitly match exact characters
